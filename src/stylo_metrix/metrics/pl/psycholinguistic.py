...
class Psycholinguistic(Metric, ABC):
    category_local = "Psycholinguistic"
...
class PS_M_VALa(Psycholinguistic):
    ...
    name_local = "Występowanie wyrazów posiadających więcej niż średni znak emocji (valence)"
...
class PS_M_VALb(Psycholinguistic):
    ...
    name_local = "Występowanie wyrazów posiadających mniej niż średni znak emocji (valence)"
...
class PS_M_AROa(Psycholinguistic):
    ...
    name_local = "Występowanie wyrazów posiadających więcej niż średnie pobudzenie (arousal)"
...
class PS_M_AROb(Psycholinguistic):
    ...
    name_local = "Występowanie wyrazów posiadających mniej niż średnie pobudzenie (arousal)"
...
class PS_M_DOMa(Psycholinguistic):
    ...
    name_local = "Występowanie wyrazów posiadających więcej niż średnie opanowanie (dominance)"
...
class PS_M_DOMb(Psycholinguistic):
    ...
    name_local = "Występowanie wyrazów posiadających mniej niż średnie opanowanie (dominance)"
...
class PS_M_ORIa(Psycholinguistic):
    ...
    name_local = "Występowanie wyrazów posiadających więcej niż średnie pochodzenie (origin)"
...
class PS_M_ORIb(Psycholinguistic):
    ...
    name_local = "Występowanie wyrazów posiadających mniej niż średnie pochodzenie (origin)"
...
class PS_M_SIGa(Psycholinguistic):
    ...
    name_local = "Występowanie wyrazów posiadających więcej niż średnie znaczenie (significance)"
...
class PS_M_SIGb(Psycholinguistic):
    ...
    name_local = "Występowanie wyrazów posiadających mniej niż średnie znaczenie (significance)"
...
class PS_M_CONa(Psycholinguistic):
    ...
    name_local = "Występowanie wyrazów posiadających więcej niż średnią konkretność (concreteness)"
...
class PS_M_CONb(Psycholinguistic):
    ...
    name_local = "Występowanie wyrazów posiadających mniej niż średnią konkretność (concreteness)"
...
class PS_M_IMGa(Psycholinguistic):
    ...
    name_local = "Występowanie wyrazów posiadających więcej niż średnia wyobrażalność (imageability)"
...
class PS_M_IMGb(Psycholinguistic):
    ...
    name_local = "Występowanie wyrazów posiadających mniej niż średnia wyobrażalność (imageability)"
...
class PS_M_AGEa(Psycholinguistic):
    ...
    name_local = "Występowanie wyrazów posiadających więcej niż średni wiek akwizycji (age of acquisition)"
...
class PS_M_AGEb(Psycholinguistic):
    ...
    name_local = "Występowanie wyrazów posiadających mniej niż średni wiek akwizycji (age of acquisition)"
