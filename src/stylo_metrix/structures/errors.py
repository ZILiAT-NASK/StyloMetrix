...
class WrongTypeError(StyloMetrixError):
    msg = f"Using wrong datatype (other than list of docs with \"metrics\" attribute)."
...
class LanguageNotImplemented(StyloMetrixError):
    msg = f"Language isn't available for StyloMetrix."
...
class FileFailedError(StyloMetrixError):
    msg = f"File failed. Check info in log."
