...
class Nouns(Inflection, ABC):
    case = ""
    name_en = ""
    name_pl = "Rzeczowniki w przypadku " + case
...
class IN_PRO_1S(Inflection):
    name_en = "First person singular personal pronoun incidence"
    name_pl = "Występowanie zaimków osobowych w 1 os. l. poj."
...
class IN_PRO_1P(Inflection):
    name_en = "First person plural personal pronoun incidence"
    name_pl = "Występowanie zaimków osobowych w 1 os. l. mn."
...
class IN_PRO_2S(Inflection):
    name_en = "Second person singular personal pronoun incidence"
    name_pl = "Występowanie zaimków osobowych w 2 os. l. poj."
...
class IN_PRO_2P(Inflection):
    name_en = "Second person plural personal pronoun incidence"
    name_pl = "Występowanie zaimków osobowych w 2 os. l. mn."
...
class IN_PRO_3S(Inflection):
    name_en = "Third person singular personal pronoun incidence"
    name_pl = "Występowanie zaimków osobowych w 3 os. l. poj."
...
class IN_PRO_3P(Inflection):
    name_en = "Third person plural personal pronoun incidence"
    name_pl = "Występowanie zaimków osobowych w 3 os. l. mn."
